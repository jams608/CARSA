...
def parse_args():
    ...
    parser.add_argument('--dataset_name', type=str, default='twitter2015', choices=['twitter2015', 'twitter2017', 'political_twitter'])
    ...
    #parser.add_argument("--early_stopping_patience", default=10, type=int, help="Number of evaluations with no improvement after which training will be stopped.")
    ...
    parser.add_argument('--beta', type=float, default=0.2, help="beta is a hyperparameter for the patch-token alignment")
    parser.add_argument('--gamma', type=float, default=0, help="gamma is a hyperparameter for the text Sentiment Enhancer")
    #parser.add_argument('--a_cls_weight', type=float, default=0.1, help='weight for a-task classification loss')
